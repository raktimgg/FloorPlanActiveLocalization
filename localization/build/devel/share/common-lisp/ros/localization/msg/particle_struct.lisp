...
(cl:defmethod cl:initialize-instance :after ((m <particle_struct>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'particle_struct)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name localization-msg:<particle_struct> is deprecated: use localization-msg:particle_struct instead.")))
...
(cl:defmethod w-val ((m <particle_struct>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization-msg:w-val is deprecated.  Use localization-msg:w instead.")
  (w m))

(cl:ensure-generic-function 'perc-val :lambda-list '(m))
(cl:defmethod perc-val ((m <particle_struct>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader localization-msg:perc-val is deprecated.  Use localization-msg:perc instead.")
  (perc m))
