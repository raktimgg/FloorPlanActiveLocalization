...
(cl:defmethod cl:initialize-instance :after ((m <GlobalDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<GlobalDescriptor> is deprecated: use sem_cloud-msg:GlobalDescriptor instead.")))
...
(cl:defmethod info-val ((m <GlobalDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:info-val is deprecated.  Use sem_cloud-msg:info instead.")
  (info m))
