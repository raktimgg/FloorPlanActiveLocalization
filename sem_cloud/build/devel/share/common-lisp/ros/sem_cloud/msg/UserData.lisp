...
(cl:defmethod cl:initialize-instance :after ((m <UserData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'UserData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<UserData> is deprecated: use sem_cloud-msg:UserData instead.")))
...
(cl:defmethod rows-val ((m <UserData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:rows-val is deprecated.  Use sem_cloud-msg:rows instead.")
  (rows m))

(cl:ensure-generic-function 'cols-val :lambda-list '(m))
(cl:defmethod cols-val ((m <UserData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:cols-val is deprecated.  Use sem_cloud-msg:cols instead.")
  (cols m))
