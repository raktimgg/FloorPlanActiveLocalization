...
(cl:defmethod cl:initialize-instance :after ((m <Point3f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point3f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<Point3f> is deprecated: use sem_cloud-msg:Point3f instead.")))
...
(cl:defmethod z-val ((m <Point3f>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:z-val is deprecated.  Use sem_cloud-msg:z instead.")
  (z m))
