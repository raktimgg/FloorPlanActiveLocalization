...
(cl:defmethod cl:initialize-instance :after ((m <Path>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Path)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<Path> is deprecated: use sem_cloud-msg:Path instead.")))
...
(cl:defmethod nodeIds-val ((m <Path>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:nodeIds-val is deprecated.  Use sem_cloud-msg:nodeIds instead.")
  (nodeIds m))
