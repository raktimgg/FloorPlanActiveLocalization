...
(cl:defclass <MapGraph> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (links
    :reader links
    :initarg :links
    :type (cl:vector sem_cloud-msg:Link)
   :initform (cl:make-array 0 :element-type 'sem_cloud-msg:Link :initial-element (cl:make-instance 'sem_cloud-msg:Link))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MapGraph>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapGraph)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<MapGraph> is deprecated: use sem_cloud-msg:MapGraph instead.")))
...
(cl:defmethod mapToOdom-val ((m <MapGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:mapToOdom-val is deprecated.  Use sem_cloud-msg:mapToOdom instead.")
  (mapToOdom m))
...
(cl:defmethod links-val ((m <MapGraph>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:links-val is deprecated.  Use sem_cloud-msg:links instead.")
  (links m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MapGraph>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'links)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'sem_cloud-msg:Link))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
