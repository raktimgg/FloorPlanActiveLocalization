...
(cl:defmethod cl:initialize-instance :after ((m <Link>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Link)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<Link> is deprecated: use sem_cloud-msg:Link instead.")))

(cl:ensure-generic-function 'fromId-val :lambda-list '(m))
(cl:defmethod fromId-val ((m <Link>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:fromId-val is deprecated.  Use sem_cloud-msg:fromId instead.")
  (fromId m))

(cl:ensure-generic-function 'toId-val :lambda-list '(m))
(cl:defmethod toId-val ((m <Link>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:toId-val is deprecated.  Use sem_cloud-msg:toId instead.")
  (toId m))
...
(cl:defmethod information-val ((m <Link>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:information-val is deprecated.  Use sem_cloud-msg:information instead.")
  (information m))
