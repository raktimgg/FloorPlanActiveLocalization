...
(cl:defclass <MapData> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (graph
    :reader graph
    :initarg :graph
    :type sem_cloud-msg:MapGraph
    :initform (cl:make-instance 'sem_cloud-msg:MapGraph))
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector sem_cloud-msg:NodeData)
   :initform (cl:make-array 0 :element-type 'sem_cloud-msg:NodeData :initial-element (cl:make-instance 'sem_cloud-msg:NodeData))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MapData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MapData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<MapData> is deprecated: use sem_cloud-msg:MapData instead.")))
...
(cl:defmethod graph-val ((m <MapData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:graph-val is deprecated.  Use sem_cloud-msg:graph instead.")
  (graph m))

(cl:ensure-generic-function 'nodes-val :lambda-list '(m))
(cl:defmethod nodes-val ((m <MapData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:nodes-val is deprecated.  Use sem_cloud-msg:nodes instead.")
  (nodes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MapData>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sem_cloud-msg:NodeData))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MapData>)))
  ...
  "8f9b7a6a9f675febbbe86bf0926d6fcd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MapData)))
  "Returns md5sum for a message object of type 'MapData"
  "8f9b7a6a9f675febbbe86bf0926d6fcd")
