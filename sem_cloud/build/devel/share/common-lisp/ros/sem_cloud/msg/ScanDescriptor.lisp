...
(cl:defmethod cl:initialize-instance :after ((m <ScanDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ScanDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<ScanDescriptor> is deprecated: use sem_cloud-msg:ScanDescriptor instead.")))
...
(cl:defmethod scan-val ((m <ScanDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:scan-val is deprecated.  Use sem_cloud-msg:scan instead.")
  (scan m))

(cl:ensure-generic-function 'scan_cloud-val :lambda-list '(m))
(cl:defmethod scan_cloud-val ((m <ScanDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sem_cloud-msg:scan_cloud-val is deprecated.  Use sem_cloud-msg:scan_cloud instead.")
  (scan_cloud m))
