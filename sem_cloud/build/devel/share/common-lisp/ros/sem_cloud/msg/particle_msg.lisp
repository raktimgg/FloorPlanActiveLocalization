...
(cl:defclass <particle_msg> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (data
    :reader data
    :initarg :data
    :type (cl:vector sem_cloud-msg:particle_struct)
   :initform (cl:make-array 0 :element-type 'sem_cloud-msg:particle_struct :initial-element (cl:make-instance 'sem_cloud-msg:particle_struct))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <particle_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'particle_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sem_cloud-msg:<particle_msg> is deprecated: use sem_cloud-msg:particle_msg instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <particle_msg>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'data)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'sem_cloud-msg:particle_struct))
