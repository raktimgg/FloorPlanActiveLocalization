...
"""autogenerated by genpy from sem_cloud/RGBDImage.msg. Do not edit."""
import codecs
import sys
...
uint8[] data"""
  ...
  _slot_types = ['std_msgs/Header','sensor_msgs/CameraInfo','sensor_msgs/CameraInfo','sensor_msgs/Image','sensor_msgs/Image','sensor_msgs/CompressedImage','sensor_msgs/CompressedImage','sem_cloud/KeyPoint[]','sem_cloud/Point3f[]','uint8[]','sem_cloud/GlobalDescriptor']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.global_descriptor is None:
        self.global_descriptor = sem_cloud.msg.GlobalDescriptor()
    else:
      self.header = std_msgs.msg.Header()
      self.rgb_camera_info = sensor_msgs.msg.CameraInfo()
      self.depth_camera_info = sensor_msgs.msg.CameraInfo()
