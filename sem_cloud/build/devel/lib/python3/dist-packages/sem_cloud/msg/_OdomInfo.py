...
"""autogenerated by genpy from sem_cloud/OdomInfo.msg. Do not edit."""
import codecs
import sys
...
class OdomInfo(genpy.Message):
  _md5sum = "1fa598d3d5fa4fd64473fc2a4cfbe1b3"
  _type = "sem_cloud/OdomInfo"
...
"""
  __slots__ = ['header','lost','matches','inliers','icpInliersRatio','icpRotation','icpTranslation','icpStructuralComplexity','icpStructuralDistribution','icpCorrespondences','covariance','features','localMapSize','localScanMapSize','localKeyFrames','localBundleOutliers','localBundleConstraints','localBundleTime','keyFrameAdded','timeEstimation','timeParticleFiltering','stamp','interval','distanceTravelled','memoryUsage','gravityRollError','gravityPitchError','localBundleIds','localBundleModels','localBundleModelTransforms','localBundlePoses','transform','transformFiltered','transformGroundTruth','guess','type','wordsKeys','wordsValues','wordMatches','wordInliers','localMapKeys','localMapValues','localScanMap','refCorners','newCorners','cornerInliers']
  _slot_types = ['std_msgs/Header','bool','int32','int32','float32','float32','float32','float32','float32','int32','float64[36]','int32','int32','int32','int32','int32','int32','float32','bool','float32','float32','float32','float32','float32','int32','float32','float32','int32[]','sensor_msgs/CameraInfo[]','geometry_msgs/Transform[]','geometry_msgs/Pose[]','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','geometry_msgs/Transform','int32','int32[]','sem_cloud/KeyPoint[]','int32[]','int32[]','int32[]','sem_cloud/Point3f[]','sensor_msgs/PointCloud2','sem_cloud/Point2f[]','sem_cloud/Point2f[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.localBundleModelTransforms is None:
        self.localBundleModelTransforms = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.localBundleModelTransforms)
      buff.write(_struct_I.pack(length))
      for val1 in self.localBundleModelTransforms:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if self.localBundleModelTransforms is None:
        self.localBundleModelTransforms = None
      if self.localBundlePoses is None:
      ...
      for i in range(0, length):
        ...
        self.localBundleModelTransforms.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.localBundlePoses = []
