...
"""autogenerated by genpy from sem_cloud/NodeData.msg. Do not edit."""
import codecs
import sys
...
class NodeData(genpy.Message):
  _md5sum = "31b69635c081fb7b97ce2c35487b27a6"
  _type = "sem_cloud/NodeData"
...
float64 value"""
  ...
  _slot_types = ['int32','int32','int32','float64','string','geometry_msgs/Pose','geometry_msgs/Pose','sem_cloud/GPS','uint8[]','uint8[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32[]','float32','geometry_msgs/Transform[]','uint8[]','int32','float32','int32','geometry_msgs/Transform','uint8[]','uint8[]','uint8[]','uint8[]','float32','sem_cloud/Point3f','int32[]','int32[]','sem_cloud/KeyPoint[]','sem_cloud/Point3f[]','uint8[]','sem_cloud/GlobalDescriptor[]','sem_cloud/EnvSensor[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.grid_view_point is None:
        self.grid_view_point = sem_cloud.msg.Point3f()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.globalDescriptors = []
      for i in range(0, length):
        val1 = sem_cloud.msg.GlobalDescriptor()
        _v11 = val1.header
        start = end
        end += 4
