...
"""autogenerated by genpy from sem_cloud/MapData.msg. Do not edit."""
import codecs
import sys
...
class MapData(genpy.Message):
  _md5sum = "8f9b7a6a9f675febbbe86bf0926d6fcd"
  _type = "sem_cloud/MapData"
...
float64 value"""
  ...
  _slot_types = ['std_msgs/Header','sem_cloud/MapGraph','sem_cloud/NodeData[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.graph is None:
        self.graph = sem_cloud.msg.MapGraph()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          val2 = sem_cloud.msg.GlobalDescriptor()
          _v43 = val2.header
          start = end
          end += 4
