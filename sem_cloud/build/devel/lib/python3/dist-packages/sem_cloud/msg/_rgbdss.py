...
"""autogenerated by genpy from sem_cloud/rgbdss.msg. Do not edit."""
import codecs
import sys
...
class rgbdss(genpy.Message):
  _md5sum = "ada45110d9d786576b747e09320e468d"
  _type = "sem_cloud/rgbdss"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """sensor_msgs/Image  rgb
...
"""
  __slots__ = ['rgb','depth','semantic']
  _slot_types = ['sensor_msgs/Image','sensor_msgs/Image','sem_cloud/Semantic']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rgbdss, self).__init__(*args, **kwds)
      ...
      if self.semantic is None:
        self.semantic = sem_cloud.msg.Semantic()
    else:
      self.rgb = sensor_msgs.msg.Image()
      self.depth = sensor_msgs.msg.Image()
      self.semantic = sem_cloud.msg.Semantic()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.semantic.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.semantic.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.semantic.data = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.semantic.data.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.semantic.data = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
