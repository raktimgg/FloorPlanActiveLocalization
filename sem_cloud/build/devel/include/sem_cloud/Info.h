// Generated by gencpp from file sem_cloud/Info.msg
// DO NOT EDIT!


#ifndef SEM_CLOUD_MESSAGE_INFO_H
#define SEM_CLOUD_MESSAGE_INFO_H
...
struct Info_
{
  ...
  _currentGoalId_type currentGoalId;
   ...
   typedef  ::sem_cloud::MapGraph_<ContainerAllocator>  _odom_cache_type;
  ...
  typedef boost::shared_ptr< ::sem_cloud::Info_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sem_cloud::Info_<ContainerAllocator> const> ConstPtr;

}; // struct Info_

typedef ::sem_cloud::Info_<std::allocator<void> > Info;

typedef boost::shared_ptr< ::sem_cloud::Info > InfoPtr;
typedef boost::shared_ptr< ::sem_cloud::Info const> InfoConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sem_cloud::Info_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sem_cloud::Info_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sem_cloud::Info_<ContainerAllocator1> & lhs, const ::sem_cloud::Info_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sem_cloud::Info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sem_cloud::Info_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sem_cloud::Info_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sem_cloud::Info_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sem_cloud::Info_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sem_cloud::Info_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sem_cloud::Info_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sem_cloud::Info_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x656fb5b8dfd8dfd2ULL;
  static const uint64_t static_value2 = 0xdc40226f35f2d440ULL;
};

template<class ContainerAllocator>
struct DataType< ::sem_cloud::Info_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sem_cloud::Info_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sem_cloud::Info_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sem_cloud::Info_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sem_cloud::Info_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << indent << "odom_cache: ";
    s << std::endl;
    Printer< ::sem_cloud::MapGraph_<ContainerAllocator> >::stream(s, indent + "  ", v.odom_cache);
  }
};
...
#endif // SEM_CLOUD_MESSAGE_INFO_H
