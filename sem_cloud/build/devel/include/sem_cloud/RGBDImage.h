// Generated by gencpp from file sem_cloud/RGBDImage.msg
// DO NOT EDIT!


#ifndef SEM_CLOUD_MESSAGE_RGBDIMAGE_H
#define SEM_CLOUD_MESSAGE_RGBDIMAGE_H
...
struct RGBDImage_
{
  ...
  _depth_compressed_type depth_compressed;
   ...
   typedef std::vector< ::sem_cloud::KeyPoint_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sem_cloud::KeyPoint_<ContainerAllocator> >> _key_points_type;
  _key_points_type key_points;

   typedef std::vector< ::sem_cloud::Point3f_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::sem_cloud::Point3f_<ContainerAllocator> >> _points_type;
  _points_type points;
  ...
  typedef boost::shared_ptr< ::sem_cloud::RGBDImage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sem_cloud::RGBDImage_<ContainerAllocator> const> ConstPtr;

}; // struct RGBDImage_

typedef ::sem_cloud::RGBDImage_<std::allocator<void> > RGBDImage;

typedef boost::shared_ptr< ::sem_cloud::RGBDImage > RGBDImagePtr;
typedef boost::shared_ptr< ::sem_cloud::RGBDImage const> RGBDImageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sem_cloud::RGBDImage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sem_cloud::RGBDImage_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sem_cloud::RGBDImage_<ContainerAllocator1> & lhs, const ::sem_cloud::RGBDImage_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sem_cloud::RGBDImage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sem_cloud::RGBDImage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sem_cloud::RGBDImage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sem_cloud::RGBDImage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sem_cloud::RGBDImage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sem_cloud::RGBDImage_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sem_cloud::RGBDImage_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sem_cloud::RGBDImage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xaffef6cc8804ffbaULL;
  static const uint64_t static_value2 = 0x98ce6ed6f1ca8942ULL;
};

template<class ContainerAllocator>
struct DataType< ::sem_cloud::RGBDImage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sem_cloud::RGBDImage_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sem_cloud::RGBDImage_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sem_cloud::RGBDImage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sem_cloud::RGBDImage_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.key_points.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::sem_cloud::KeyPoint_<ContainerAllocator> >::stream(s, indent + "    ", v.key_points[i]);
    }
    ...
    for (size_t i = 0; i < v.points.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::sem_cloud::Point3f_<ContainerAllocator> >::stream(s, indent + "    ", v.points[i]);
    }
...
#endif // SEM_CLOUD_MESSAGE_RGBDIMAGE_H
